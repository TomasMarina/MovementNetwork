...
## Sites visited before and after sharing night site
...
indB6_bef <- data_raw %>%
  ...
  select(date, hour, site, lon, lat, colonia, ind)
...
sitemap_indB6_bef <- ggplot() +
  geom_sf(data = shapefile_idle) +
  geom_point(data = indB6_bef, aes(lon, lat),
             colour = ifelse(indB6_bef$site == 6, "red", "blue")) +
  theme_bw() +
  theme(axis.line = element_line(),
        axis.title.x = element_blank(),
        axis.title.y = element_blank()) +
...
sitemap_indB6_aft <- ggplot() +
  geom_sf(data = shapefile_idle) +
  geom_point(data = indB6_aft, aes(lon, lat), colour = "blue") +
  theme_bw() +
  theme(axis.line = element_line(),
        axis.title.x = element_blank(),
        axis.title.y = element_blank()) +
...
sitemap_indE_bef <- ggplot() +
  geom_sf(data = shapefile_idle) +
  geom_point(data = indE_bef, aes(lon, lat),
             colour = ifelse(indE_bef$site == 6, "red", "blue")) +
  theme_bw() +
  theme(axis.line = element_line(),
        axis.title.x = element_blank(),
        axis.title.y = element_blank()) +
...
sitemap_indE_aft <- ggplot() +
  geom_sf(data = shapefile_idle) +
  geom_point(data = indE_aft, aes(lon, lat), colour = "blue") +
  theme_bw() +
  theme(axis.line = element_line(),
        axis.title.x = element_blank(),
        axis.title.y = element_blank()) +
...
sitemap_indA_bef <- ggplot() +
  geom_sf(data = shapefile_idle) +
  geom_point(data = indA_bef, aes(lon, lat),
             colour = ifelse(indA_bef$site == 153, "red", "blue")) +
  theme_bw() +
  theme(axis.line = element_line(),
        axis.title.x = element_blank(),
        axis.title.y = element_blank()) +
...
sitemap_indA_aft <- ggplot() +
  geom_sf(data = shapefile_idle) +
  geom_point(data = indA_aft, aes(lon, lat), colour = "blue") +
  theme_bw() +
  theme(axis.line = element_line(),
        axis.title.x = element_blank(),
        axis.title.y = element_blank()) +
...
sitemap_indB1_bef <- ggplot() +
  geom_sf(data = shapefile_idle) +
  geom_point(data = indB1_bef, aes(lon, lat),
             colour = ifelse(indB1_bef$site == 153, "red", "blue")) +
  theme_bw() +
  theme(axis.line = element_line(),
        axis.title.x = element_blank(),
        axis.title.y = element_blank()) +
...
sitemap_indB1_aft <- ggplot() +
  geom_sf(data = shapefile_idle) +
  geom_point(data = indB1_aft, aes(lon, lat), colour = "blue") +
  theme_bw() +
  theme(axis.line = element_line(),
        axis.title.x = element_blank(),
        axis.title.y = element_blank()) +
