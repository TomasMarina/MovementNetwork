...
nodes_colonia_day <- nodes_colonia[nodes_colonia$time == 'day', ]
no_sites_col_day <- nrow(nodes_colonia_day)
nodes_colonia_night <- nodes_colonia[nodes_colonia$time == 'night', ]
no_sites_col_night <- nrow(nodes_colonia_night)
nodes_colonia_both <- nodes_colonia[nodes_colonia$time == 'both', ]
no_sites_col_both <- nrow(nodes_colonia_both)
nodes_col_prepen
nodes_col_pospen
...
# site #10 was considered as colony site
links_col <- links_all
...
# To be continue: netmwork maps pre and pospenguin departure
